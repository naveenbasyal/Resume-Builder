  ...
  return (
    <Container>
      ...
      {currentPage === "preview" && (
        <Row className="d-flex align-items-center justify-content-center mt-5">
          <Col className="shadow-out col-lg-8 p-5">
            <h1 className="textClip ">Preview Your Resume</h1>
            <div className="buttonWrap my-3 d-flex">
              <Button
                className="next-btn mx-3 shadow-out"
            ...
            <div className="resumePreview">
              <div className="resumePreview__left">
                <div className="resumePreview__left__top">
                  <img src={basicInfo.image} alt="profileImg" />
                  <div className="resumePreview__left__top__name">
                    <h2>{basicInfo.name}</h2>
                    <h3>{basicInfo.profession}</h3>
                  </div>
                </div>
                <div className="resumePreview__left__bottom">
                  <h3>About</h3>
                  <p>{basicInfo.about}</p>
                </div>
              </div>
              <div className="resumePreview__right">
                <div className="resumePreview__right__top">
                  <h3>Education</h3>
                  <div className="resumePreview__right__top__education">
                    <h4>{educationDetails.degree}</h4>
                    <h5>{educationDetails.institute}</h5>
                    <p>{educationDetails.year}</p>
                  </div>
                </div>
                <div className="skills">
                  ...
                  <div className="skills__container">
                    <div className="skills__container__skill">
                      <h4>{skill1}</h4>
                      <div className="skills__container__skill__bar">
                        <div
                          className="skills__container__skill__bar__fill"
                          style={{ width: `${skillLevel_1}%` }}
                        ></div>
                      </div>
                    </div>
                    <div className="skills__container__skill">
                ...
                {/* <div className="resumePreview__right__bottom">
                  <h3>Experience</h3>
                  <div className="resumePreview__right__bottom__experience">
                    <h4>{experienceInfo.designation}</h4>
                    <h5>{experienceInfo.company}</h5>
                    <p>{experienceInfo.year}</p>
                  </div>
                </div> */}
              </div>
            </div>
